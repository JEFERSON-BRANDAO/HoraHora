<%@ Page Title="Yield - BOT" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="YieldBot.aspx.cs" Inherits="HoraHora.YieldBot" %>
        ...
        <ContentTemplate>
            <div class="blocoGrupoCampos">
                ...
                <div class="blocoGrupoCampos">
                    ...
                    <div id="divLado" runat="server" visible="true" class="blocoeditor" style="border-color: #4b6c9e;
