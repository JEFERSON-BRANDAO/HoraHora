<%@ Page Title="Yield - TOP" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="YieldTop.aspx.cs" Inherits="HoraHora.YieldTop" %>
        ...
        <ContentTemplate>
            <div class="blocoGrupoCampos">
                <div class="blocoGrupoCampos">
                    <div class="blocoeditor" style="border-color: #000000; background-color: #000000;
                        ...
                        <div style="margin-left: 255px">
                            <asp:Label ID="lbYielD_" runat="server" Text="YIELD RATE" Font-Bold="true" ForeColor="White"
                    ...
                    <%-- <div style="margin-left: 600px">
                        <asp:Label ID="lbEficiencia" runat="server" Text="Eficiência" Font-Bold="true" ForeColor="Black"
                            Font-Size="22"></asp:Label>
                ...
                <div class="blocoGrupoCampos">
                    ...
                    <div id="divLado" runat="server" visible="false" class="blocoeditor" style="border-color: #4b6c9e;
                    ...
                    <div class="blocoeditor" style="margin-left: 10px">
                        <asp:GridView ID="gridHoraHora" runat="server" AutoGenerateColumns="False" BackColor="White"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="target" HeaderText="YIELD TARGET">
                                    <ItemStyle HorizontalAlign="Center" Width="80px" Font-Bold="True" />
                                </asp:BoundField>
                        ...
                        <div id="diYield" runat="server" class="blocoeditor" style="margin-top: 1px; margin-left: -8px;
                            border-color: #4b6c9e; background-color: #4b6c9e; width: 85px; height: 25px">
                            <div style="margin-left: 5px">
                                <asp:Label ID="lbYield" runat="server" Text="0%" Font-Bold="true" ForeColor="White"
                                    Font-Size="12"></asp:Label>
                            </div>
                        </div>
                        <div class="blocoeditor" style="margin-top: 1px; margin-left: -8px; border-color: #4b6c9e;
                            background-color: #4b6c9e; width: 450px; height: 25px">
                        </div>
